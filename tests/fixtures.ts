 ...
 * primary CTA — blocking clicks in CI. We don't test Termly itself
 * here (cookie consent is out of scope), so preventing the script
 * from loading gives us a deterministic, chrome-free UI.
 */
