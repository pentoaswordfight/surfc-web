...
braird is for your **personal use**. Your note content is **end-to-end encrypted** — the keys are yours, and we cannot read it. How we handle data is set out in our [Privacy Policy](/policies/privacy/), which is part of these Terms.
...
- break the law, or use braird to infringe someone else's rights;
...
You can stop using braird and delete your account at any time. We may suspend or end your access if you break these Terms or the law, or if we need to for security or legal reasons. When your account ends, we handle your data as described in the [Privacy Policy](/policies/privacy/).
...
Email: hello@braird.app · Phone: +41 76 525 21 03
